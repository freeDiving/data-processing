# Plot :
# * figure 5(b), the total uplink size during Just-a-Line initial synchronization
# * figure 5(c), the total downlink packet size during Just-a-Line initial synchronization
