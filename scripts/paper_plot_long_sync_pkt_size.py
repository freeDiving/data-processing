# Plot uplink/downlink packets during initial synchronization
...
def output_chart(
    ...
    #ax1.set_xticks(pd.date_range(sync_start, sync_end, freq='1 ms'))
    ...
    plt.legend(loc="upper right", fontsize=my_font_size)
    filename = 'Init_Sync_Timeline_Long.pdf'
...
def main():
    ...
    for index, host_path in enumerate(host_dirs):
        ...
        filename = 'sync_pkt_size-vs-time.pdf'
