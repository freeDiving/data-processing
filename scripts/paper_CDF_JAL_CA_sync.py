...
def main():
    ...
    plt.xlabel("Latency (s)", fontsize=my_font_size)
    plt.xticks(fontsize=my_font_size)
    ax.set_xticks(ax.get_xticks()[::2])
    plt.yticks(fontsize=my_font_size)
    plt.plot(jal_sync_elapsed_time_list_sorted, np.linspace(0, 1, jal_sync_elapsed_time_list_sorted.size), label="Just a Line: sync.", linewidth=4)
    plt.plot(cloud_anchor_e2e_time_list_sorted, np.linspace(0, 1, cloud_anchor_e2e_time_list_sorted.size), label="Cloud Anchor: E2E", linewidth=4)
    ...
    p = np.percentile(jal_sync_elapsed_time_list_sorted, 75)
    print("The max E2E of just-a-line is: ", max(jal_sync_elapsed_time_list_sorted))
    print("The 75th percentile E2E of just-a-line is: ", p)
    print("The min E2E of just-a-line is: ", min(jal_sync_elapsed_time_list_sorted))
