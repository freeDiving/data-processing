...
#         display_filter="tcp.flags.syn == 1 && tcp.flags.ack == 0 && {ip_filter}".format(
#             ip_filter=display_filter_for_ip(phone_ip))
#     )
#     for pkt, index in enumerate(cap_host_syn):
#         if index == 0:
#             firebase_ip = get_ip(pkt, dir='dst')
#         else:
#             arcore_ip_list.append(get_ip(pkt, dir='dst'))
#     return firebase_ip, arcore_ip_list
